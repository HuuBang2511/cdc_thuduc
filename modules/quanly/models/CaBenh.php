...
class CaBenh extends QuanlyBaseModel
{
    ...
    public function rules()
    {
        return [
            ...
            [['benhviennhap_id'], 'exist', 'skipOnError' => true, 'targetClass' => BenhVien::className(), 'targetAttribute' => ['benhviennhap_id' => 'id']],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'loai_ca_benh' => 'Thông tin loại ca bệnh',
            'stt' => 'STT',
            'dantoc_id' => 'Dân tộc',
            ...
            'phuongxa_truonghoc' => 'Phường trường học',
            ...
            'sonha_benhnoikhac' => 'Số nhà bệnh nơi khác',
            ...
            'tiepxuc_tcm' => 'Tiếp xúc người mắc TCM',
            'dinhatre_tcm' => 'Đi nhà trẻ/ mẫu giáo/ trường học/ nhóm trẻ gia đình',
            ...
            'loaiodich__id' => 'Kết luận loại ổ dịch',
            ...
            'tinhtrang_dieutra' => 'Tình trạng điều tra',
            'ngayhandieutra' => 'Ngày hạn điều tra',
            'tiendo_dieutra' => 'Tiến độ điều tra',
            'is_dieutra' => 'Tiến hành điều tra',
            'khupho_sxhtp' => 'Khu phố sxh thành phố', 
            'tenduong_sxhtp' => 'Tên đường sxh thành phố',
            'kp' => 'Khu phố',
            'duong' => 'Tên đường',
            'khuphonoikhac_sxhtp' => 'Khu phố nơi khác sxh thành phố', 
            'duongnoikhac_sxhtp' => 'Tên đường nơi khác sxh thành phố',
            'tenbenhviennhap_sxhtp' => 'Bệnh viện nhập sxh thành phố',
            'nha_couongthuoc_sxh' => 'Nhà có người uống thuốc hạ sốt',
            'odichcu' => 'Ổ dịch cũ',
            'odichcu_xuly' => 'Ổ dịch cũ xử lý',
            'xuly' => 'Xử lý',
            'xuly_ngay' => 'Ngày xử lý',
            'benhvien_sxhtp' => 'Bệnh viện sxh thành phố',
            'nha_cabenh_tcm' => 'Nhà có ca bệnh TCM',
            'phuongxa_cutrunoikhac' => 'Phường xã cư trú nơi khác',
            'diachi_cutrunoikhac' => 'Địa chỉ cư trú nơi khác',
            'offline_id_sxh' => 'offline_id_sxh',
            'benhviennhap_id' => 'Bệnh viện nhập',
        ];
    }
    ...
    public function getBenhviennhap()
    {
        return $this->hasOne(BenhVien::className(), ['id' => 'benhviennhap_id']);
    }
